...
/**
 * Persistent 5-slot trinket pouch for endgame accessories.
 * Each slot stores an item ID, count, and durability. Serialized via BuilderCodec.
 */
public class AccessoryPouchData {

    public static final int MAX_SLOTS = 5;

    @Nonnull
    public static final BuilderCodec<AccessoryPouchData> CODEC = BuilderCodec
            .builder(AccessoryPouchData.class, AccessoryPouchData::new)
    ...
    public AccessoryPouchData(AccessoryPouchData other) {
