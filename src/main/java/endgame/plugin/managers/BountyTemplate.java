...
public class BountyTemplate {
    ...
    private static final List<BountyTemplate> EASY_POOL = Arrays.asList(
        new BountyTemplate("easy_saurian_10", BountyType.KILL_NPC, "Saurian_Warrior", 10,
                BountyDifficulty.EASY, "Slay 10 Saurian Warriors", "Endgame_Drop_Gauntlet_5"),
        new BountyTemplate("easy_werewolf_5", BountyType.KILL_NPC, "Werewolf", 5,
                BountyDifficulty.EASY, "Slay 5 Werewolves", "Endgame_Drop_Gauntlet_5"),
        new BountyTemplate("easy_ghoul_15", BountyType.KILL_NPC, "Ghoul", 15,
                BountyDifficulty.EASY, "Slay 15 Ghouls", "Endgame_Drop_Gauntlet_5"),
        new BountyTemplate("easy_scarak_10", BountyType.KILL_NPC, "Scarak_Fighter", 10,
                BountyDifficulty.EASY, "Slay 10 Scarak Fighters", "Endgame_Drop_Gauntlet_5"),
        new BountyTemplate("easy_shadow_3", BountyType.KILL_NPC, "Shadow_Knight", 3,
                BountyDifficulty.EASY, "Slay 3 Shadow Knights", "Endgame_Drop_Gauntlet_5"),
        new BountyTemplate("easy_combo_2", BountyType.COMBO_TIER, null, 2,
                BountyDifficulty.EASY, "Reach Combo x3 Tier", "Endgame_Drop_Gauntlet_5"),
        new BountyTemplate("easy_trial_1", BountyType.COMPLETE_TRIAL, null, 1,
                BountyDifficulty.EASY, "Complete a Warden Challenge (Tier I+)", "Endgame_Drop_Gauntlet_5"),
        new BountyTemplate("easy_rat_frost_12", BountyType.KILL_NPC, "Endgame_Rat_Frost", 12,
                BountyDifficulty.EASY, "Slay 12 Frost Rats (Frozen Dungeon)", "Endgame_Drop_Gauntlet_5"),
        new BountyTemplate("easy_toad_frost_8", BountyType.KILL_NPC, "Endgame_Toad_Frost", 8,
                BountyDifficulty.EASY, "Slay 8 Frost Toads (Frozen Dungeon)", "Endgame_Drop_Gauntlet_5"),
        new BountyTemplate("easy_spirit_root_6", BountyType.KILL_NPC, "Spirit_Root", 6,
                BountyDifficulty.EASY, "Slay 6 Root Spirits", "Endgame_Drop_Gauntlet_5"),
        new BountyTemplate("easy_saurian_hunter_8", BountyType.KILL_NPC, "Endgame_Saurian_Hunter", 8,
                BountyDifficulty.EASY, "Slay 8 Saurian Hunters (Zone 4)", "Endgame_Drop_Gauntlet_5"),
        new BountyTemplate("easy_saurian_rogue_6", BountyType.KILL_NPC, "Endgame_Saurian_Rogue", 6,
                BountyDifficulty.EASY, "Slay 6 Saurian Rogues (Zone 4)", "Endgame_Drop_Gauntlet_5", 50, 1),
        // Phase 2: New bounty types in easy pool
        new BountyTemplate("easy_craft_mithril_ore_3", BountyType.CRAFT_ITEM, "Ore_Mithril", 3,
                BountyDifficulty.EASY, "Craft 3 Mithril Ore", "Endgame_Drop_Gauntlet_5", 40, 1),
        new BountyTemplate("easy_damage_500", BountyType.DAMAGE_DEALT, null, 500,
                BountyDifficulty.EASY, "Deal 500 damage to bosses", "Endgame_Drop_Gauntlet_5", 60, 1)
    );
    ...
    private static final List<BountyTemplate> MEDIUM_POOL = Arrays.asList(
        new BountyTemplate("med_rex_2", BountyType.KILL_NPC, "Alpha_Rex", 2,
                BountyDifficulty.MEDIUM, "Slay 2 Alpha Rex", "Endgame_Drop_Gauntlet_10"),
        new BountyTemplate("med_duke_3", BountyType.KILL_NPC, "Goblin_Duke", 3,
                BountyDifficulty.MEDIUM, "Slay 3 Goblin Dukes", "Endgame_Drop_Gauntlet_10"),
        new BountyTemplate("med_boss_1", BountyType.KILL_ANY_BOSS, null, 1,
                BountyDifficulty.MEDIUM, "Defeat any Boss", "Endgame_Drop_Gauntlet_10"),
        new BountyTemplate("med_trial_2", BountyType.COMPLETE_TRIAL, null, 2,
                BountyDifficulty.MEDIUM, "Complete Warden Challenge (Tier II+)", "Endgame_Drop_Gauntlet_10"),
        new BountyTemplate("med_trial_3", BountyType.COMPLETE_TRIAL, null, 3,
                BountyDifficulty.MEDIUM, "Complete Warden Challenge (Tier III+)", "Endgame_Drop_Gauntlet_10"),
        new BountyTemplate("med_combo_3", BountyType.COMBO_TIER, null, 3,
                BountyDifficulty.MEDIUM, "Reach Combo x4 Tier", "Endgame_Drop_Gauntlet_10"),
        new BountyTemplate("med_necro_3", BountyType.KILL_NPC, "Necromancer_Void", 3,
                BountyDifficulty.MEDIUM, "Slay 3 Void Necromancers", "Endgame_Drop_Gauntlet_10"),
        new BountyTemplate("med_yeti_2", BountyType.KILL_NPC, "Endgame_Yeti", 2,
                BountyDifficulty.MEDIUM, "Slay 2 Yetis (Frozen Dungeon)", "Endgame_Drop_Gauntlet_10"),
        new BountyTemplate("med_croc_4", BountyType.KILL_NPC, "Endgame_Swamp_Crocodile", 4,
                BountyDifficulty.MEDIUM, "Slay 4 Swamp Crocodiles (Swamp Dungeon)", "Endgame_Drop_Gauntlet_10"),
        new BountyTemplate("med_outlander_3", BountyType.KILL_NPC, "Outlander_Brute", 3,
                BountyDifficulty.MEDIUM, "Slay 3 Outlander Brutes", "Endgame_Drop_Gauntlet_10"),
        new BountyTemplate("med_frost_feran_4", BountyType.KILL_NPC, "Frost_Feran", 4,
                BountyDifficulty.MEDIUM, "Slay 4 Frost Feran (Frozen Dungeon)", "Endgame_Drop_Gauntlet_10"),
        new BountyTemplate("med_spirit_frost_5", BountyType.KILL_NPC, "Spirit_Frost", 5,
                BountyDifficulty.MEDIUM, "Slay 5 Frost Spirits (Frozen Dungeon)", "Endgame_Drop_Gauntlet_10"),
        new BountyTemplate("med_golem_frost_2", BountyType.KILL_NPC, "Endgame_Golem_Crystal_Frost", 2,
                BountyDifficulty.MEDIUM, "Slay 2 Frost Golems (Frozen Dungeon)", "Endgame_Drop_Gauntlet_10"),
        ...
        new BountyTemplate("med_craft_mithril_sword", BountyType.CRAFT_ITEM, "Weapon_Sword_Mithril", 1,
                BountyDifficulty.MEDIUM, "Craft a Mithril Sword", "Endgame_Drop_Gauntlet_10", 120, 2),
        new BountyTemplate("med_dungeon_clear_1", BountyType.DUNGEON_CLEAR, null, 1,
                BountyDifficulty.MEDIUM, "Clear a dungeon instance", "Endgame_Drop_Gauntlet_10", 150, 2),
        new BountyTemplate("med_damage_2000", BountyType.DAMAGE_DEALT, null, 2000,
                BountyDifficulty.MEDIUM, "Deal 2000 damage to bosses", "Endgame_Drop_Gauntlet_10", 120, 2)
    );
    ...
    private static final List<BountyTemplate> HARD_POOL = Arrays.asList(
        new BountyTemplate("hard_boss_2", BountyType.KILL_ANY_BOSS, null, 2,
                BountyDifficulty.HARD, "Defeat 2 Bosses", "Endgame_Drop_Gauntlet_20"),
        new BountyTemplate("hard_trial_4", BountyType.COMPLETE_TRIAL, null, 4,
                BountyDifficulty.HARD, "Complete Warden Challenge (Tier IV)", "Endgame_Drop_Gauntlet_20"),
        new BountyTemplate("hard_combo_4", BountyType.COMBO_TIER, null, 4,
                BountyDifficulty.HARD, "Reach FRENZY Combo Tier", "Endgame_Drop_Gauntlet_20"),
        new BountyTemplate("hard_speed_hedera", BountyType.SPEED_KILL_BOSS, "Endgame_Hedera", 240,
                BountyDifficulty.HARD, "Defeat Hedera in under 4 minutes", "Endgame_Drop_Gauntlet_20"),
        new BountyTemplate("hard_speed_dragon", BountyType.SPEED_KILL_BOSS, "Endgame_Dragon_Frost", 180,
                BountyDifficulty.HARD, "Defeat Frost Dragon in under 3 minutes", "Endgame_Drop_Gauntlet_20"),
        new BountyTemplate("hard_spectre_5", BountyType.KILL_NPC, "Spectre_Void", 5,
                BountyDifficulty.HARD, "Slay 5 Void Spectres", "Endgame_Drop_Gauntlet_20"),
        new BountyTemplate("hard_aberrant_2", BountyType.KILL_NPC, "Zombie_Aberrant", 2,
                BountyDifficulty.HARD, "Slay 2 Zombie Aberrants", "Endgame_Drop_Gauntlet_20"),
        new BountyTemplate("hard_broodmother_1", BountyType.KILL_NPC, "Scarak_Broodmother", 1,
                BountyDifficulty.HARD, "Slay a Scarak Broodmother", "Endgame_Drop_Gauntlet_20"),
        new BountyTemplate("hard_speed_golem", BountyType.SPEED_KILL_BOSS, "Endgame_Golem_Void", 300,
                BountyDifficulty.HARD, "Defeat Void Golem in under 5 minutes", "Endgame_Drop_Gauntlet_20"),
        new BountyTemplate("hard_boss_3", BountyType.KILL_ANY_BOSS, null, 3,
                BountyDifficulty.HARD, "Defeat 3 Bosses", "Endgame_Drop_Gauntlet_20"),
        ...
        new BountyTemplate("hard_craft_prisma_sword", BountyType.CRAFT_ITEM, "Endgame_Sword_Prisma", 1,
                BountyDifficulty.HARD, "Craft a Prisma Sword", "Endgame_Drop_Gauntlet_20", 250, 3),
        new BountyTemplate("hard_dungeon_clear_3", BountyType.DUNGEON_CLEAR, null, 3,
                BountyDifficulty.HARD, "Clear 3 dungeon instances", "Endgame_Drop_Gauntlet_20", 300, 3),
        new BountyTemplate("hard_damage_5000", BountyType.DAMAGE_DEALT, null, 5000,
                BountyDifficulty.HARD, "Deal 5000 damage to bosses", "Endgame_Drop_Gauntlet_20", 250, 3)
    );
